...
// config for @stylistic/eslint-plugin 1.5.1
...
export const stylisticRules = {
	...
	rules: {
		...
		'stylistic/jsx-closing-tag-location': SEVERITY.OFF,

		// https://eslint.style/rules/default/jsx-closing-bracket-location
		'stylistic/jsx-closing-bracket-location': [SEVERITY.OFF, {
		...
		'stylistic/jsx-indent': [SEVERITY.ERROR, 'tab', {
			checkAttributes: true,
			indentLogicalExpressions: true,
		}],

		// https://eslint.style/rules/default/jsx-indent-props
		'stylistic/jsx-indent-props': [SEVERITY.ERROR, {
			indentMode: 'tab',
		...
		// TODO: think about all combinations
