...
export const SOUND = {
	...
	CASINO: '/audio/casino.mp3',
	CHIPI_CHIPI: '/audio/chipi-chipi.mp3',
	COMING: '/audio/coming.mp3',
	...
	KILLER: '/audio/killer.mp3',
	MINECRAFT: '/audio/minecraft.mp3',
	NOT_BAD: '/audio/not-bad.mp3',
	PARLAMENT: '/audio/parlament.mp3',
	POGNALI: '/audio/pognali.mp3',
	POLLKA: '/audio/pollka.mp3',
	PRIVAT: '/audio/privat.mp3',
	RAKETA: '/audio/raketa.mp3',
...
export const SOUND_LABEL: Record<Sound, string> = {
	...
	[SOUND.NOT_BAD]: 'Not Bad',
	[SOUND.PARLAMENT]: 'Parlament',
	[SOUND.POGNALI]: 'Pognalu',
	[SOUND.POLLKA]: 'Pollka',
	[SOUND.PRIVAT]: 'Privat',
	[SOUND.RAKETA]: 'Raketa',
