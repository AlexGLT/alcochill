...
export const TIME_IN_SECONDS: Record<TimeMetric, number> = {
	...
	[TimeMetric.MONTH]: TIME_METRIC_LIMITS.SECOND * TIME_METRIC_LIMITS.MINUTE * TIME_METRIC_LIMITS.HOUR * TIME_METRIC_LIMITS.DAY, // eslint-disable-line stylistic/max-len
	[TimeMetric.YEAR]: TIME_METRIC_LIMITS.SECOND * TIME_METRIC_LIMITS.MINUTE * TIME_METRIC_LIMITS.HOUR * TIME_METRIC_LIMITS.DAY * TIME_METRIC_LIMITS.MONTH, // eslint-disable-line stylistic/max-len
};
